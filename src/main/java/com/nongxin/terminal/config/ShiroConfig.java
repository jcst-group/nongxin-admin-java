...
import com.nongxin.terminal.module.shiro.AppRealm;
import com.nongxin.terminal.module.shiro.MyModularRealmAuthorizer;
import com.nongxin.terminal.module.shiro.MyRealm;
import com.nongxin.terminal.module.shiro.ShowRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/fileInfo/downFile", "anon"); 		//文件下载接口过滤
		...
		filterChainDefinitionMap.put("/show/user/login", "anon");				//看板登录接口过滤
		...
		filterChainDefinitionMap.put("/proTraceability/getMaterialPic", "anon");
		filterChainDefinitionMap.put("/proTraceability/getPicByBatchId", "anon");*/
		filterChainDefinitionMap.put("/proTraceability/**", "anon");
		...
		filterChainDefinitionMap.put("/envmonitor/**","anon");
		filterChainDefinitionMap.put("/app/weather/**","anon");
		//测试用，可删除

...
public class PushUtil {
    ...
    // STEP1：获取应用基本信息
    private static String appId = "yaJQsrad237gdKS9ldmey5";
    private static String appKey = "SjSxhJwC3W7Gs5I4Cjrvq9";
    private static String masterSecret = "4uwYTfg9CC9Jop4GhDqAN2";

...
import com.nongxin.terminal.util.enumUtil.base.*;
...
public class EnumController {
    ...
    public Result getDetectionUnitEnum(){
        Result result = new Result();
        result.setSuccessResult(DetectionUnitEnum.values());
        return result;
    }
    ...
    @GetMapping("/getThemeEnum")
    @ApiOperation("获取工作记录状态")
    public Result getThemeEnum(){
        Result result = new Result();
        result.setSuccessResult(ThemeEnum.values());
        return result;
    }

    @GetMapping("/getFruitColorEnum")
    @ApiOperation("获取果品颜色")
    public Result getFruitColorEnum(){
        Result result = new Result();
        result.setSuccessResult(FruitColorEnum.values());
        return result;
    }

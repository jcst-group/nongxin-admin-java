...
public class EnvMonitorServiceImpl implements EnvMonitorService {
    ...
    @Override
    public List<EnvMonitor> getEnvMonitorList(Integer factoryId,Integer equipmentId,Integer baseId, Date startTime, Date endTime) {
        return dao.getEnvMonitorList(factoryId,equipmentId,baseId,startTime,endTime);
    }

    @Override
    public List<EnvMonitor> getEnvChart(Integer factoryId,Integer equipmentId, Integer baseId, Date startTime, Date endTime) {
        return dao.getEnvChart(factoryId,equipmentId,baseId,startTime,endTime);
    }

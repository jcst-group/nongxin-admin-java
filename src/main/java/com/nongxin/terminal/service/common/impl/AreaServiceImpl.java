...
public class AreaServiceImpl implements AreaService {
    ...
    @Override
    public List<String> getMzArea() {
        return areaMapper.getMzArea();
    }
    ...
    public String getAreaName(String areaCode) {
        return areaMapper.getAreaName(areaCode);
    }

    @Override
    public String getAreaNameByFullName(String fullName) {
        return areaMapper.getAreaNameByFullName(fullName);
    }
}

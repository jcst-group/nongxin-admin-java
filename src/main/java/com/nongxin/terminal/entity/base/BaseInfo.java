...
public class BaseInfo {
    ...
    private List<PictureInfo> basePic;
    ...
    private PictureInfo pesticideResiduesPic;

    private PictureInfo sugarContentPic;

    private PictureInfo fruitReportPic;
    ...
    private List<SugarContent> sugarContents;

    private FruitGrading fruitGrading;

    public PictureInfo getFruitReportPic() {
        return fruitReportPic;
    }

    public void setFruitReportPic(PictureInfo fruitReportPic) {
        this.fruitReportPic = fruitReportPic;
    }

    public FruitGrading getFruitGrading() {
        return fruitGrading;
    }

    public void setFruitGrading(FruitGrading fruitGrading) {
        this.fruitGrading = fruitGrading;
    }

    public List<SugarContent> getSugarContents() {
        return sugarContents;
    }

    public void setSugarContents(List<SugarContent> sugarContents) {
    ...
    public List<PictureInfo> getBasePic() {
        return basePic;
    }

    public void setBasePic(List<PictureInfo> basePic) {
    ...
    public PictureInfo getPesticideResiduesPic() {
        return pesticideResiduesPic;
    }

    public void setPesticideResiduesPic(PictureInfo pesticideResiduesPic) {
        this.pesticideResiduesPic = pesticideResiduesPic;
    }

    public PictureInfo getSugarContentPic() {
        return sugarContentPic;
    }

    public void setSugarContentPic(PictureInfo sugarContentPic) {
        this.sugarContentPic = sugarContentPic;
    }
}
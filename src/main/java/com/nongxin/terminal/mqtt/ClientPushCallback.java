...
public class ClientPushCallback implements MqttCallback {
    ...
    private static final String TOPIC01 = "stds/up/CL/865650041122314";
    private static final String TOPIC02 = "stds/up/CL/865650041121837";
    private static final String TOPIC03 = "stds/up/CL/865650041122165";
    private static final String TOPIC04 = "stds/up/CL/865650041121878";
    //设备上线topic
        ...
        if(recieve!=null&&!recieve.equals("close")){
            switch (topic){
                ...
                case TOPIC4:
                    ...
                    break;
                case TOPIC01:
                    equipmentId = "865650041122314";
                    recieve(recieve,equipmentId);   //解析数据
                    insert();   //数据入库
                    break;
                case TOPIC02:
                    equipmentId = "865650041121837";
                    recieve(recieve,equipmentId);
                    insert();
                    break;
                case TOPIC03:
                    equipmentId = "865650041122165";
                    recieve(recieve,equipmentId);
                    insert();
                    break;
                case TOPIC04:
                    equipmentId = "865650041121878";
                    recieve(recieve,equipmentId);
                    insert();
                    break;
                case TOPIC5:
